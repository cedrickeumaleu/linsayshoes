	...
	//Pro feature
		class Cozipress_testimonial_section_upgrade extends WP_Customize_Control {
			...
			<?php }elseif('CoziPlus' == $theme->name){ ?>
				...
				<a class="customizer_CoziPress_testimonial_upgrade_section up-to-pro" href="https://burgerthemes.com/cozipress-pro/" target="_blank" style="display: none;"><?php _e('More Testimonial Available in CoziPlus Pro','cozipress'); ?></a>		
